...
public class TagController {
    ...
    @GetMapping("/tags")
    public String list(@PageableDefault(size = 1,sort = {"id"}, direction = Sort.Direction.DESC)
    ...
    public String editPost(@Valid Tag tag, BindingResult result, @PathVariable Long id, RedirectAttributes attributes) {
        ...
        if (t == null ) {
            attributes.addFlashAttribute("message", "更新失败jkjk");
        } else {
            attributes.addFlashAttribute("message", "更新成功klk");
        }
